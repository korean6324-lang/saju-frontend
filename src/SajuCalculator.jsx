...
// 🌐 5개 국어 다국어 딕셔너리 (줄바꿈 복원)
const UI = {
  ko: {
    appTitle: "명리",
    appSubtitle: "글로벌 초정밀 사주 & 궁합 엔진",
    tabSaju: "👤 개인 사주 분석",
    tabGunghap: "💑 프리미엄 궁합",
    name: "이름 (닉네임)",
    gender: "성별",
    ...
    bDate: "생년월일",
    bTime: "태어난 시간",
    timeUnk: "시간을 정확히 모릅니다",
    btnRect: "🔮 생시 추론하기",
    btnSaju: "명리-PRO 원국 분석하기",
    btnGunghap: "명리-PRO 궁합 확인",
    loading: "명리-PRO 엔진 가동 중...",
    myInfo: "👤 나의 정보",
    ptInfo: "💖 상대방 정보",
    menuWhy: "🔍 Why 명리-PRO?",
    menuSub: "매일 운세 무료 구독 💌",
    menuContact: "플랫폼 제공 및 문의",
    rIljin: "📅 오늘의 운세 (일진)",
    rPillar: "님의 사주 원국표",
    rElement: "📊 오행 밸런스 및 타고난 그릇",
    rStory: "📖 심층 스토리텔링",
    rDynamic: "⚡ 원국 내 상호작용 및 주의할 운세",
    rFlow: "🛤️ 운명의 흐름 (대/세/월운)"
  },
  en: {
    appTitle: "Myeongri",
    appSubtitle: "Global Precision Saju Engine",
    tabSaju: "👤 Personal Saju",
    tabGunghap: "💑 Premium Match",
    name: "Name (Nickname)",
    gender: "Gender",
    male: "Male",
    female: "Female",
    ...
    bDate: "Date of Birth",
    bTime: "Time of Birth",
    timeUnk: "I don't know the exact time",
    btnRect: "🔮 Estimate Time",
    btnSaju: "Analyze My Saju",
    btnGunghap: "Check Compatibility",
    loading: "Running Engine...",
    myInfo: "👤 My Info",
    ptInfo: "💖 Partner's Info",
    menuWhy: "🔍 Why Myeongri-PRO?",
    menuSub: "Daily Horoscope Sub 💌",
    menuContact: "Contact & Platform",
    rIljin: "📅 Today's Fortune",
    rPillar: "'s Saju Pillars",
    rElement: "📊 Five Elements & Capacity",
    rStory: "📖 In-depth Storytelling",
    rDynamic: "⚡ Interactions & Dynamics",
    rFlow: "🛤️ Flow of Destiny"
  },
  ja: {
    appTitle: "命理",
    appSubtitle: "グローバル精密四柱推命エンジン",
    tabSaju: "👤 個人四柱推命",
    tabGunghap: "💑 プレミアム相性",
    name: "名前（ニックネーム）",
    gender: "性別",
    ...
    rElement: "📊 五行バランスと器",
    rStory: "📖 深層ストーリー",
    rDynamic: "⚡ 相互作用と注意すべき運勢",
    rFlow: "🛤️ 運命の流れ（大/年/月運）"
  },
  zh: {
    appTitle: "命理",
    appSubtitle: "全球高精度八字与合婚引擎",
    tabSaju: "👤 个人八字分析",
    tabGunghap: "💑 高级合婚",
    name: "姓名 (昵称)",
    gender: "性别",
  ...
  es: {
    appTitle: "Myeongri",
    appSubtitle: "Motor Global de Saju y Compatibilidad",
    tabSaju: "👤 Saju Personal",
    tabGunghap: "💑 Compatibilidad Premium",
    name: "Nombre (Apodo)",
    gender: "Género",
    male: "Hombre",
    female: "Mujer",
    ...
    solar: "Solar",
    lunar: "Lunar",
    lunarLeap: "Lunar (Bisiesto)",
    loc: "País/Ciudad (Longitud)",
    bDate: "Fecha de Nacimiento",
    bTime: "Hora de Nacimiento",
    timeUnk: "No sé la hora exacta",
    btnRect: "🔮 Estimar Hora",
    btnSaju: "Analizar mi Saju",
    btnGunghap: "Ver Compatibilidad",
    loading: "Procesando...",
    myInfo: "👤 Mi Info",
    ptInfo: "💖 Info de Pareja",
    menuWhy: "🔍 ¿Por qué Myeongri-PRO?",
    menuSub: "Horóscopo Diario 💌",
    menuContact: "Contacto",
    rIljin: "📅 Fortuna de Hoy",
    rPillar: " - Pilares del Destino",
    rElement: "📊 Elementos y Capacidad",
    rStory: "📖 Historia Profunda",
    rDynamic: "⚡ Interacciones",
    rFlow: "🛤️ Flujo del Destino"
  }
};
...
export default function SajuCalculator() {
  ...
  const handleRectifySubmit = async () => {
    try {
      ...
      const payload = { 
        ...formData, 
        q1_trait: rectifyData.q1, 
        q2_time: rectifyData.q2, 
        longitude: locData.lon, 
        timezone: locData.tz 
      };
  ...
  const openModal = (keyword) => {
    ...
    if (TERMS_DICT[lookupKeyword]) {
      ...
      setModalInfo({ title: keyword, desc: "해당 단어의 상세 사전 데이터가 준비 중입니다." });
    }
  };
  ...
  const groupedDynamic = result?.dynamic_relations ? Object.values(result.dynamic_relations.reduce((acc, rel) => {
    ...
    if (!acc[key]) {
      acc[key] = { ...rel, un_types: [rel.un_type] };
    } else if (!acc[key].un_types.includes(rel.un_type)) {
      acc[key].un_types.push(rel.un_type);
    }
    return acc;
  }, {})) : [];
    ...
    <>
      ...
      <div className={`side-menu ${isMenuOpen ? 'open' : ''}`}>
        <div className="menu-header">
          <h2 style={{ margin: 0, fontSize: '1.5em', color: '#1C2536', fontWeight: '900' }}>
            {t.appTitle}<span style={{ color: '#B59960' }}>-PRO</span>
          </h2>
          <button 
            onClick={() => setIsMenuOpen(false)} 
        ...
        <div style={{ paddingBottom: '5px' }}>
          <button 
            ...
            onClick={() => { setActiveTab('saju'); setIsMenuOpen(false); }}
          >
            <span style={{ fontSize: '1.2em' }}>👤</span> {t.tabSaju}
          </button>
          <button 
            className="menu-nav-btn" 
            onClick={() => { setActiveTab('gunghap'); setIsMenuOpen(false); }}
          >
            <span style={{ fontSize: '1.2em' }}>💑</span> {t.tabGunghap}
          </button>
        </div>
        ...
        <div className="menu-content">
          <div className="menu-box">
            <h4 className="accordion-title" onClick={() => setIsWhyProOpen(!isWhyProOpen)}>
              <span>{t.menuWhy}</span>
              <svg 
                className={`accordion-icon ${isWhyProOpen ? 'open' : ''}`} 
          ...
          <div className="subscribe-banner">
            ...
            <p style={{ margin: 0, fontSize: '0.85em', color: '#0F172A', lineHeight: '1.5' }}>
              오늘의 운세와 이달의 운세를 매일 아침 전송해 드립니다. <br/>
              <strong>👉 카카오톡 / 텔레그램 연동 예정</strong>
            </p>
          </div>
        </div>
      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '20px', paddingBottom: '60px' }}>
        ...
        {/* 🌟 메인 헤더 & 언어팩 아이콘 (좌측 배치 완벽 구현) 🌟 */}
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '10px', marginBottom: '25px' }}>
          
          {/* 좌측: 언어 선택 국기 아이콘 (심플한 원형 배지 형태) */}
          ...
          <div style={{ textAlign: 'center', flex: 2 }}>
            ...
            <p style={{ margin: '6px 0 0', color: '#6B7280', fontSize: '0.8em', fontWeight: '600', wordBreak: 'keep-all' }}>
              {t.appSubtitle}
            </p>
          </div>
        ...
        {error && (
          <div className="fade-in" style={{ padding: '16px', backgroundColor: '#FEF2F2', borderLeft: '4px solid #EF4444', color: '#991B1B', borderRadius: '8px', marginBottom: '20px', fontWeight: '600' }}>
            {error}
          </div>
        )}
          ...
          <div className="fade-in">
            <form onSubmit={handleSajuSubmit} className="premium-card">
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '15px' }}>
                ...
                <div style={{ flex: '1 1 140px' }}>
                  <label className="label-text">{t.gender}</label>
                  <div style={{ display: 'flex', gap: '5px', height: '49px' }}>
                    <button 
                      type="button" 
                      onClick={() => setFormData({...formData, gender: 'M'})} 
                      style={{ flex: 1, borderRadius: '8px', border: formData.gender === 'M' ? '2px solid #1C2536' : '1px solid #E2DED5', background: formData.gender === 'M' ? '#F3F4F6' : '#FAFAFA', fontWeight: formData.gender === 'M' ? '700' : '500', color: formData.gender === 'M' ? '#1C2536' : '#9CA3AF', cursor: 'pointer' }}
                    >
                      {t.male}
                    </button>
                    <button 
                      ...
                      style={{ flex: 1, borderRadius: '8px', border: formData.gender === 'F' ? '2px solid #1C2536' : '1px solid #E2DED5', background: formData.gender === 'F' ? '#F3F4F6' : '#FAFAFA', fontWeight: formData.gender === 'F' ? '700' : '500', color: formData.gender === 'F' ? '#1C2536' : '#9CA3AF', cursor: 'pointer' }}
                    >
                      {t.female}
                    </button>
                  </div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '15px' }}>
                <div style={{ flex: '1 1 100px' }}>
                  ...
                  >
                    ...
                    <option value="lunar_leap">{t.lunarLeap}</option>
                  </select>
                </div>
                <div style={{ flex: '2 1 180px' }}>
                  <label className="label-text">{t.loc}</label>
                  <select 
                    className="input-field" 
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '20px' }}>
                <div style={{ flex: '1 1 140px' }}>
                  <label className="label-text">{t.bDate}</label>
                  <input 
                    type="date" 
                    className="input-field" 
                    required 
                ...
                <div style={{ flex: '1 1 120px', opacity: isTimeUnknown ? 0.4 : 1, transition: 'opacity 0.3s' }}>
                  <label className="label-text">{t.bTime}</label>
                  <input 
                    type="time" 
                    className="input-field" 
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px', padding: '12px', backgroundColor: '#F9F8F6', borderRadius: '10px' }}>
                <label style={{ fontSize: '0.9em', color: '#4B5563', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', fontWeight: '500' }}>
                  <input 
                    type="checkbox" 
                    style={{ width: '18px', height: '18px', accentColor: '#B59960' }} 
                ...
                <button 
                  ...
                  style={{ padding: '8px 16px', backgroundColor: '#FFF', color: '#B59960', border: '1px solid #D4AF37', borderRadius: '8px', fontSize: '0.85em', fontWeight: '700', cursor: 'pointer', boxShadow: '0 2px 5px rgba(212,175,55,0.1)' }}
                >
                  {t.btnRect}
                </button>
              </div>
              ...
              <button type="submit" className="btn-primary" disabled={loading}>
                {loading ? <><div className="spinner"></div> {t.loading}</> : t.btnSaju}
              </button>
            </form>
            ...
            {result && (
              <div className="fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div className="premium-card" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#F0F9FF', border: '1px solid #BAE6FD' }}>
                  <div>
                    <div style={{ fontSize: '0.85em', fontWeight: 'bold', color: '#0369A1', marginBottom: '4px', cursor: 'pointer' }} onClick={() => openModal("일진")}>
                      {t.rIljin}
                    </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      <div onClick={() => openModal(result.iljin.ganji[0])} style={{ fontSize: '1.6em', fontWeight: '900', color: getElementColor(result.iljin.ganji[0]), cursor: 'pointer', lineHeight: '1.2' }}>
                        {result.iljin.ganji[0]}
                      </div>
                      <div onClick={() => openModal(result.iljin.sipseong[0])} style={{ fontSize: '0.75em', color: '#64748B', cursor: 'pointer' }}>
                        {result.iljin.sipseong[0]}
                      </div>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      <div onClick={() => openModal(result.iljin.ganji[1])} style={{ fontSize: '1.6em', fontWeight: '900', color: result.iljin.is_gongmang ? '#EF4444' : getElementColor(result.iljin.ganji[1]), cursor: 'pointer', lineHeight: '1.2' }}>
                        {result.iljin.ganji[1]}
                      </div>
                      <div onClick={() => openModal(result.iljin.sipseong[1])} style={{ fontSize: '0.75em', color: '#64748B', cursor: 'pointer' }}>
                        {result.iljin.sipseong[1]}
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    {['년주', '월주', '일주', '시주'].map((pillarKey) => {
                      ...
                      return (
                        <div key={pillarKey} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#FDFCFB', padding: '20px 5px', borderRadius: '12px', border: '1px solid #EFECE6', boxShadow: 'inset 0 2px 4px rgba(0,0,0,0.02)' }}>
                          <div style={{ fontSize: '0.8em', color: '#9CA3AF', fontWeight: '700', marginBottom: '12px' }}>
                            {pillarKey}
                          </div>
                          
                          <div style={{ textAlign: 'center', marginBottom: '15px' }}>
                            <div onClick={() => !isUnknown && openModal(data.ganji[0])} style={{ fontSize: '2em', fontWeight: '900', color: getElementColor(data.ganji[0]), cursor: isUnknown ? 'default' : 'pointer', lineHeight: '1.1' }}>
                              {data.ganji[0]}
                            </div>
                            <div onClick={() => !isUnknown && openModal(data.sipseong[0])} style={{ fontSize: '0.8em', color: '#6B7280', cursor: isUnknown ? 'default' : 'pointer', marginTop: '6px' }}>
                              {data.sipseong[0]}
                            </div>
                          </div>
                          ...
                          <div style={{ textAlign: 'center', marginBottom: '15px' }}>
                            <div onClick={() => !isUnknown && openModal(data.ganji[1])} style={{ fontSize: '2em', fontWeight: '900', color: data.is_gongmang ? '#EF4444' : getElementColor(data.ganji[1]), cursor: isUnknown ? 'default' : 'pointer', lineHeight: '1.1' }}>
                              {data.ganji[1]}
                            </div>
                            <div onClick={() => !isUnknown && openModal(data.sipseong[1])} style={{ fontSize: '0.8em', color: '#6B7280', cursor: isUnknown ? 'default' : 'pointer', marginTop: '6px' }}>
                              {data.sipseong[1]}
                            </div>
                          </div>
                          ...
                          {!isUnknown && (
                            <div style={{ display: 'flex', gap: '4px', justifyContent: 'center', marginBottom: '10px', cursor: 'pointer' }} title="지장간">
                              ...
                              {data.jijanggan?.map((gan, idx) => (
                                <span key={idx} onClick={() => openModal(gan)} style={{ fontSize: '0.75em', color: '#6B7280', fontWeight: '600' }}>{gan}</span>
                              ))}
                              <span style={{ fontSize: '0.65em', color: '#94A3B8' }} onClick={() => openModal("지장간")}>]</span>
                            </div>
                          )}
                          ...
                          {!isUnknown && (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', width: '100%', alignItems: 'center' }}>
                              {data.shipi && data.shipi !== "-" && (
                                <span onClick={() => openModal(data.shipi)} style={{ fontSize: '0.65em', padding: '3px 8px', backgroundColor: '#E0F2FE', color: '#1E3A8A', borderRadius: '4px', cursor: 'pointer' }}>
                                  {data.shipi}
                                </span>
                              )}
                              {data.is_gongmang && (
                                <span onClick={() => openModal("공망")} style={{ fontSize: '0.65em', padding: '3px 8px', backgroundColor: '#FEE2E2', color: '#991B1B', borderRadius: '4px', cursor: 'pointer' }}>
                                  공망
                                </span>
                              )}
                              {data.sinsal.map((sal, idx) => {
                                let bg = '#F3F4F6', color = '#475569', border = '#E2E8F0';
                                if (sal.includes('대살') || sal.includes('괴강')) { 
                                  bg = '#FFEBEE'; color = '#C62828'; border = '#FFCDD2'; 
                                } else if (sal.includes('천을귀인')) { 
                                  bg = '#FFF8E1'; color = '#F57F17'; border = '#FFECB3'; 
                                } 
                                return (
                                  <span key={idx} onClick={() => openModal(sal)} style={{ fontSize: '0.65em', padding: '3px 8px', backgroundColor: bg, color: color, borderRadius: '4px', border: `1px solid ${border}`, cursor: 'pointer' }}>
                                    {sal}
                                  </span>
                                );
                              })}
                ...
                <div className="premium-card">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '25px' }}>
                    {Object.entries(result.elements_ratio).map(([element, ratio]) => (
                      <div key={element} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <strong onClick={() => openModal(element)} style={{ cursor: 'pointer', width: '20px', color: getElementColor(element) }}>
                          {element}
                        </strong>
                        ...
                        <span style={{ fontSize: '0.85em', color: '#64748B', width: '35px', textAlign: 'right' }}>
                          {ratio}%
                        </span>
                      </div>
                    ))}
                  ...
                  <div style={{ backgroundColor: '#FDFBFB', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '20px', marginBottom: '15px' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '0.95em', color: '#334155', lineHeight: '1.5' }}>
                      {result.gyeokguk.description}
                    </p>
                  </div>

                  {result.yongshin.special_type && (
                    <div style={{ backgroundColor: '#F5F3FF', border: '1px solid #C4B5FD', borderRadius: '12px', padding: '15px', display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '15px' }}>
                      ...
                      <p style={{ margin: 0, fontSize: '0.85em', color: '#4C1D95', lineHeight: '1.4' }}>
                        {result.yongshin.special_desc}
                      </p>
                    </div>
                  )}
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px' }}>
                    <div style={{ flex: '1 1 45%', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '15px' }}>
                      <h4 style={{ margin: '0 0 10px 0', fontSize: '0.95em', color: '#1E293B' }}>
                        ⚖️ 억부 용신 <span style={{ fontSize: '0.75em', color: '#64748B', fontWeight: 'normal' }}>(세력 밸런스)</span>
                      </h4>
                        ...
                        <div style={{ flex: 1, backgroundColor: '#F0FDF4', borderRadius: '8px', padding: '10px' }}>
                          ...
                          <div style={{ display: 'flex', gap: '5px' }}>
                            {result.yongshin.yong_hee.map((el, i) => (
                              <span key={i} onClick={() => openModal(el)} style={{ cursor: 'pointer', fontWeight: 'bold', color: getElementColor(el), fontSize: '1.1em' }}>{el}</span>
                            ))}
                          </div>
                        </div>
                    ...
                    <div style={{ flex: '1 1 45%', backgroundColor: '#FFF7ED', border: '1px solid #FFEDD5', borderRadius: '12px', padding: '15px' }}>
                      <h4 style={{ margin: '0 0 10px 0', fontSize: '0.95em', color: '#9A3412' }}>
                        🌡️ 조후 용신 <span style={{ fontSize: '0.75em', color: '#FDBA74', fontWeight: 'normal' }}>(온도 밸런스)</span>
                      </h4>
                      ...
                      <p style={{ margin: 0, fontSize: '0.85em', color: '#9A3412', lineHeight: '1.4' }}>
                        {result.johu.description}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="premium-card">
                  ...
                  <div style={{ marginBottom: '20px' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '0.95em', color: '#4B5563', lineHeight: '1.7' }}>
                      {result.interpretation.five_elements_desc}
                    </p>
                  </div>
                  ...
                  <div style={{ marginBottom: '20px' }}>
                    ...
                    <p style={{ margin: 0, fontSize: '0.95em', color: '#4B5563', lineHeight: '1.7' }}>
                      {result.interpretation.movement_luck} <br/><br/> {result.interpretation.job_wealth_desc}
                    </p>
                  </div>
                ...
                {/* 5. 상호작용 및 알림 */}
                <div className="premium-card">
                  <h3 style={{ margin: '0 0 15px 0', fontSize: '1.2em', color: '#1C2536' }}>
                    {t.rDynamic}
                  </h3>
                          ...
                          return (
                            <div key={idx} style={{ borderLeft: `4px solid ${isHaphwa ? '#8B5CF6' : rel.name.includes('합') ? '#10B981' : '#EF4444'}`, padding: '12px', backgroundColor: '#F8FAFC', borderRadius: '6px' }}>
                              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                                ...
                                <span style={{ fontSize: '0.85em', color: '#3B82F6', fontWeight: '700' }}>
                                  [{rel.positions.join(' ↔ ')}]
                                </span>
                              </div>
                              <p style={{ margin: 0, fontSize: '0.9em', color: '#475569', lineHeight: '1.4' }}>
                                {rel.description}
                              </p>
                            </div>
                          )
                  ...
                  {groupedDynamic.length > 0 && (
                    <div style={{ backgroundColor: '#FFFBEB', border: '1px solid #FCD34D', borderRadius: '12px', padding: '16px' }}>
                      <h4 style={{ margin: '0 0 10px 0', fontSize: '1em', color: '#B45309', display: 'flex', alignItems: 'center', gap: '6px' }}>
                        🔔 지금 주목해야 할 운세 변화
                      </h4>
                          ...
                          return (
                            <div key={idx} style={{ display: 'flex', flexDirection: 'column', gap: '6px', backgroundColor: isHighlight ? '#EFF6FF' : '#FFF', border: isHighlight ? '1px solid #BFDBFE' : '1px solid #FEF3C7', padding: '12px', borderRadius: '8px' }}>
                              <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
                                <span onClick={() => openModal(rel.type)} style={{ fontSize: '0.85em', fontWeight: 'bold', color: isHighlight ? '#0369A1' : '#92400E', cursor: 'pointer', textDecoration: 'underline' }}>
                                  {rel.name}
                                </span>
                ...
                {/* 6. 흐름표 */}
                <div className="premium-card">
                  <h3 style={{ margin: '0 0 20px 0', fontSize: '1.2em', color: '#1C2536' }}>
                    {t.rFlow}
                  </h3>
                      ...
                      <div className="horizontal-scroll">
                        {result.wolun.map((wun, idx) => (
                          <div key={idx} style={{ minWidth: '65px', padding: '12px 4px', border: wun.is_current ? '2px solid #8B5CF6' : '1px solid #E2E8F0', borderRadius: '8px', textAlign: 'center', backgroundColor: wun.is_current ? '#F5F3FF' : '#FFF' }}>
                            <div style={{ fontSize: '0.75em', color: '#64748B', marginBottom: '6px', fontWeight: wun.is_current ? 'bold' : 'normal' }}>
                              {wun.month}월
                            </div>
                            <div onClick={() => openModal(wun.ganji[0])} style={{ fontSize: '1.2em', fontWeight: 'bold', color: getElementColor(wun.ganji[0]), cursor: 'pointer' }}>
                              {wun.ganji[0]}
                            </div>
                            <div onClick={() => openModal(wun.ganji[1])} style={{ fontSize: '1.2em', fontWeight: 'bold', color: wun.is_gongmang ? '#EF4444' : getElementColor(wun.ganji[1]), cursor: 'pointer', marginBottom: '4px' }}>
                              {wun.ganji[1]}
                            </div>
                            <div style={{ display: 'flex', gap: '4px', justifyContent: 'center', marginBottom: '6px' }}>
                              {wun.jijanggan?.map((gan, i) => (
                                <span key={i} onClick={() => openModal(gan)} style={{ fontSize: '0.65em', color: '#9CA3AF', cursor: 'pointer' }}>{gan}</span>
                              ))}
                            </div>
                            <div onClick={() => openModal(wun.shipi)} style={{ fontSize: '0.7em', color: '#6B7280', cursor: 'pointer' }}>
                              {wun.shipi}
                            </div>
                          </div>
                        ))}
                      ...
                      {result.seun.map((wun, idx) => {
                        ...
                        return (
                          <div key={idx} style={{ minWidth: '65px', padding: '12px 4px', border: isCurrent ? '2px solid #10B981' : '1px solid #E2E8F0', borderRadius: '8px', textAlign: 'center', backgroundColor: isCurrent ? '#ECFDF5' : '#FFF' }}>
                            <div style={{ fontSize: '0.75em', color: '#64748B', marginBottom: '2px' }}>
                              {wun.year}
                            </div>
                            <div style={{ fontSize: '0.85em', fontWeight: 'bold', color: '#EF4444', marginBottom: '6px' }}>
                              {wun.age}세
                            </div>
                            <div onClick={() => openModal(wun.ganji[0])} style={{ fontSize: '1.2em', fontWeight: 'bold', color: getElementColor(wun.ganji[0]), cursor: 'pointer' }}>
                              {wun.ganji[0]}
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                      ...
                      <span style={{ fontSize: '0.75em', color: '#6366F1', cursor: 'pointer' }} onClick={() => openModal("교운기")}>
                        💡 교운기란?
                      </span>
                    </div>
                    <div className="horizontal-scroll">
                      {result.daewun.map((wun, idx) => {
                        ...
                        return (
                          <div key={idx} style={{ minWidth: '70px', padding: '12px 4px', border: isCurrent ? '2px solid #3B82F6' : '1px solid #E2E8F0', borderRadius: '8px', textAlign: 'center', backgroundColor: isCurrent ? '#EFF6FF' : '#FFF', opacity: wun.age > 90 ? 0.6 : 1 }}>
                            <div style={{ fontSize: '0.85em', fontWeight: 'bold', color: isCurrent ? '#1D4ED8' : '#EF4444', marginBottom: '6px' }}>
                              {wun.age}세
                            </div>
                            <div onClick={() => openModal(wun.ganji[0])} style={{ fontSize: '1.2em', fontWeight: 'bold', color: getElementColor(wun.ganji[0]), cursor: 'pointer' }}>
                              {wun.ganji[0]}
                            ...
                            <div onClick={() => openModal(wun.shipi)} style={{ fontSize: '0.7em', color: '#6B7280', cursor: 'pointer', marginBottom: '8px' }}>
                              {wun.shipi}
                            </div>
            ...
            <form onSubmit={handleGunghapSubmit} className="premium-card">
              ...
              <div style={{ backgroundColor: '#F9F8F6', padding: '20px', borderRadius: '12px', marginBottom: '20px', border: '1px solid #EFECE6' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '15px' }}>
                  ...
                  <div style={{ flex: '2 1 180px' }}>
                    ...
                    <select 
                      className="input-field" 
                      value={gunghapData.me.birthPlace} 
                      onChange={(e) => setGunghapData(prev => ({...prev, me: {...prev.me, birthPlace: e.target.value}}))}
                    >
                      {GLOBAL_LOCATIONS.map(loc => ( 
                        <option key={loc.id} value={loc.id}>{loc.label}</option> 
                      ))}
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '10px' }}>
                  ...
                  <div style={{ flex: '1 1 120px', opacity: gunghapData.me.is_time_unknown ? 0.4 : 1 }}>
                    <label className="label-text">{t.bTime}</label>
                    <input 
                      type="time" 
                      className="input-field" 
              ...
              <div style={{ backgroundColor: '#FFF5F7', padding: '20px', borderRadius: '12px', marginBottom: '25px', border: '1px solid #FCE7F3' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '15px' }}>
                  <div style={{ flex: '1 1 140px' }}>
                    ...
                    <input 
                      ...
                      placeholder={t.name} 
                      name="name" 
                      value={gunghapData.partner.name} 
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '15px' }}>
                  ...
                  <div style={{ flex: '2 1 180px' }}>
                    ...
                    <select 
                      className="input-field" 
                      style={{ borderColor: '#FBCFE8' }} 
                      value={gunghapData.partner.birthPlace} 
                      onChange={(e) => setGunghapData(prev => ({...prev, partner: {...prev.partner, birthPlace: e.target.value}}))}
                    >
                      {GLOBAL_LOCATIONS.map(loc => ( 
                        <option key={loc.id} value={loc.id}>{loc.label}</option> 
                      ))}
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginBottom: '10px' }}>
                  ...
                  <div style={{ flex: '1 1 120px', opacity: gunghapData.partner.is_time_unknown ? 0.4 : 1 }}>
                    <label className="label-text">{t.bTime}</label>
                    <input 
                      type="time" 
                      className="input-field" 
              ...
              <button type="submit" className="btn-primary" style={{ background: 'linear-gradient(135deg, #BE185D 0%, #9D174D 100%)', color: '#FFF' }} disabled={loading}>
                {loading ? <><div className="spinner" style={{ borderColor: 'rgba(255,255,255,0.3)', borderTopColor: '#FFF' }}></div> {t.loading}</> : t.btnGunghap}
              </button>
            </form>
          ...
          <div style={{ backgroundColor: '#FFF', padding: '30px', borderRadius: '20px', maxWidth: '400px', width: '100%' }}>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              <button 
                ...
                style={{ flex: 1, padding: '14px', backgroundColor: '#F3F4F6', color: '#4B5563', border: 'none', borderRadius: '10px', fontWeight: 'bold' }}
              >
                취소
              </button>
              <button 
                ...
                disabled={loading} 
                style={{ flex: 2, padding: '14px', backgroundColor: '#B59960', color: '#FFF', border: 'none', borderRadius: '10px', fontWeight: 'bold' }}
              >
                {loading ? '...' : t.btnRect}
              </button>
            </div>
      ...
      {modalInfo && (
        <div className="fade-in" style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(17, 24, 39, 0.6)', backdropFilter: 'blur(3px)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1000, padding: '20px' }} onClick={() => setModalInfo(null)}>
          <div style={{ backgroundColor: '#FFF', padding: '30px', borderRadius: '20px', maxWidth: '340px', width: '100%', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }} onClick={(e) => e.stopPropagation()}>
            ...
            <p style={{ margin: 0, lineHeight: '1.7', color: '#4B5563', fontSize: '1em', wordBreak: 'keep-all' }}>
              {modalInfo.desc}
            </p>
          </div>
        </div>
